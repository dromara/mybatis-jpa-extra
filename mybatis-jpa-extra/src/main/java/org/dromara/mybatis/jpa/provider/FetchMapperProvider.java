...
import org.dromara.mybatis.jpa.provider.impl.FetchProvider;
 ...
 * @param <T>
 */
public class FetchMapperProvider <T extends JpaEntity,ID extends Serializable>{    
    static final Logger logger     =     LoggerFactory.getLogger(FetchMapperProvider.class);
    
    public FetchMapperProvider() {
